...
public extension SettingsDictionary {
    ...
    func setProvisioningDevelopment() -> SettingsDictionary {
        merging(["PROVISIONING_PROFILE_SPECIFIER": SettingValue(stringLiteral: "LookMonster iOS Debug")])
            .merging(["PROVISIONING_PROFILE": SettingValue(stringLiteral: "LookMonster iOS Debug")])
    }
    
    func setProvisioningAppstore() -> SettingsDictionary {
        merging(["PROVISIONING_PROFILE_SPECIFIER": SettingValue(stringLiteral: "LookMonster iOS Release")])
            .merging(["CODE_SIGN_IDENTITY[sdk=iphoneos*]": SettingValue(stringLiteral: "iPhone Distribution")])
            .merging(["PROVISIONING_PROFILE": SettingValue(stringLiteral: "LookMonster iOS Release")])
    }
}
